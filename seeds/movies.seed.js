...
//going to give sync await a try
const startSeeding = async () => {
  try {
    await mongoose.connect("mongodb://127.0.0.1:27017/lab-express-cinema")
    console.log("Connected to database")
    await Movies.insertMany(allMovies)
    console.log("Inserted a bunch of boring movies")
    await mongoose.connection.close()
    console.log("connection closed to your slooooooooooooooooow server")
  } catch (terribleError) {
    console.log(terribleError)
  }
}

startSeeding();

//! A PRO TIP NEVER FORGET
//! CODING WITH A BEER MAKES THE CODE APPEAR
